  ...
  <xsl:template match="Product">
    <li>
      ...
      <ul>
        ...
        <xsl:if test="count(Compliance/DsDsg)!=0">
          <li>
            ...
            <ul>
              <xsl:apply-templates select="Compliance/DsDsg[string(ComplianceThreshold/@aboveComplianceThreshold)='true']" />
            </ul>
          </li>
          <li>
  ...
  <xsl:template match="Material">
    <li>
      <span class="Material">
        ...
        <input class="tag" id="comment_{generate-id()}" value="{@comment}" />
        <input class="tag" id="materialClassID_{generate-id()}" value="{MaterialClassID/EntryID/@entryIdentity}" />
        <input class="tag" id="name_{generate-id()}" value="{@name}" />
        <input class="tag" id="mass_{generate-id()}" value="{Mass/@mass}" />
        <input class="tag" id="unitOfMeasure_{generate-id()}" value="{Mass/@unitOfMeasure}" />
        <input class="tag" id="massPlusTolerance_{generate-id()}" value="{Mass/@positiveTolerance}" />
  ...
  <xsl:template match="DsDsg">
    <li>
      <span class="Substance">
        ...
        <input class="tag" id="reportableApplication_{generate-id()}" value="{ComplianceThreshold/@reportableApplication}" />
        <input class="tag" id="reportingThreshold_{generate-id()}" value="{ComplianceThreshold/@reportingThreshold}" />
        <input class="tag" id="authority_{generate-id()}" value="{UniqueID/@authority}" />
        <input class="tag" id="identity_{generate-id()}" value="{UniqueID/@identity}" />
      </span>
